...
async function seed() {
  ...
  await db.collection('leases').doc('lease-john-2026').set({
    ...
    deposit: 2400,
    status: 'active',
    documentStatus: 'active_lease',
    agreement: {
      lessor: { name: 'Sunset Properties LLC', email: 'owner@sunset.demo', phone: '+63 900 000 0001', address: '100 Sunset Blvd' },
      lessee: {
        name: 'John Smith',
        email: 'john@example.com',
        phone: '+63 900 000 0002',
        address: '42 Demo Street, Manila',
        dateOfBirth: '1990-05-15',
        civilStatus: 'Single',
        nationality: 'Filipino',
        emergencyContactName: 'Jane Smith',
        emergencyContactPhone: '+63 900 000 0003',
      },
      property: {
        propertyName: 'Sunset Apartments',
      ...
      terms: {
        ...
        paymentDueDay: 1,
        paymentMethods: ['bank_transfer', 'gcash'],
        tenantUtilities: ['electricity', 'water', 'internet'],
        utilityBillingNotes: 'Tenant pays utilities directly to providers.',
        maxOccupants: 2,
        authorizedOccupants: ['John Smith', '', ''],
      },
    },
    createdAt: now,
    updatedAt: now,
